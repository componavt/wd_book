...
WHERE
{
...

    {
  	...
  	{ 
      { ?item wdt:P178 wd:Q14647  } UNION # dev Sun Microsystems
      { ?item wdt:P178 wd:Q208371 }       # Johnson Space Center
    }  
}
\end{lstlisting}%
...
WHERE
{
    ...
    FILTER (LANG(?item_label) = "en") . 
      ...
      { ?item wdt:P275 wd:Q308915  }  UNION  # Mozzila Public
      { ?item wdt:P275 wd:Q334661  }  UNION  # MIT
      { ?item wdt:P275 wd:Q191307  }  UNION  # BSD
      { ?item wdt:P275 wd:Q6905323 }         # CC
}
\end{lstlisting}%
...
WHERE
{
    ...
    { ?developer wdt:P159 ?location. } UNION # headquarters loc.
