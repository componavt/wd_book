...
\index{Chart!BubbleChart / Bubble chart by the number of sister cities of countries}
\begin{lstlisting}[ language=SPARQL, 
...
\index{Chart!Map / Map of closest neighbours of Russia by number of sister cities}
\begin{lstlisting}[ language=SPARQL, 
