...
This chapter is dedicated to \wdqName{anime}{1107} Wikidata object analysis. Using SPARQL queries executed on Wikidata objects of anime type, several tasks were accomplished. These include a list of names of seiyu (voice actors) and their number of roles, the histogram of seiyu that acted in one or more anime, the graph connecting seiyu and anime they voiced, and the seiyu's activity age is estimated.
