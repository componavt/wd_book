...
The \emph{?seiyu} variable (lines 7--9) contains an array of Wikidata objects which correspond to several seiyu like \wdqName{Kazue Komiya}{6381410} and others. We picked only nine seiyu for illustration purposes as the graph for more seiyu would be uncomfortable for reading.
