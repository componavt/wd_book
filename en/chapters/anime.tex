...
\begin{enumerate}
	...
	\item Create histograms similar to Figure~\ref{fig:Seiyu_age_hist_EN}, but taking into account the gender of the voice actor (one for men, the other for women).
\end{enumerate}
