...
\begin{lstlisting}[ language=SPARQL, caption={Images of ships, about which films were shot. 5 images are found, 2021. SPARQL-query: \href{https://w.wiki/vez}{https://w.wiki/vez}}, label=lst:filmed_ships, ]
...
\begin{lstlisting}[ language=SPARQL, caption={Images of ships, about which books were written. 8 images are found, 2021. SPARQL-query: \href{https://w.wiki/vf2}{https://w.wiki/vf2}}, label=lst:ships_in_books, ]
SELECT DISTINCT ?image
WHERE
{
