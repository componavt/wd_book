...
\begin{marginfigure}[0cm]
	...
	\caption{Soviet airship \Wikiref{SSSR-V6 OSOAVIAKhIM}.}
	\labfig{fig:airship_question_answers_aircraft_en_2}
\end{marginfigure}
...
Which aircraft is shown in~\reffig{fig:airship_question_answers_aircraft_en_2}?

\end{exercise}

The aircraft shown in~\reffig{fig:airship_question_answers_aircraft_en_2} is an airship. 
...
\small{Question from page~\pageref{question:ship_1}.}
...
Other possible solutions from Wikidata. The data may differ because of incompleteness of wikidata objects' properties, see the listings \ref{lst:long_ship} and \ref{lst:wide_ship}.
\begin{lstlisting}[ language=SPARQL, caption={The longest ship. Ship in result: \href{https://www.wikidata.org/wiki/Q48817670}{NMS Mircea}, length is \num{36} m. SPARQL-query: \href{https://w.wiki/vev}{https://w.wiki/vev}}, label=lst:long_ship, ]
...
\begin{lstlisting}[ language=SPARQL, caption={The widest ship. Ship in result: \href{https://www.wikidata.org/wiki/Q1156392}{Project Habakkuk}, 2021, width \num{180} m. SPARQL-query: \href{https://w.wiki/w7X}{https://w.wiki/w7X}}, label=lst:wide_ship, ]
...
\small{Question from page~\pageref{question:ship_2}.}
...
\begin{lstlisting}[ language=SPARQL, caption={Images of ships, about which films were shot. 5 images are found, 2021. SPARQL-query: \href{https://w.wiki/vi7}{https://w.wiki/vi7}}, label=lst:filmed_ships, ]
...
\begin{lstlisting}[ language=SPARQL, caption={Images of ships, about which books were written. 8 images are found, 2021. SPARQL-query: \href{https://w.wiki/vi8}{https://w.wiki/vi8}}, label=lst:ships_in_books, ]
SELECT DISTINCT ?image
WHERE
{
...
\small{Question from page~\pageref{question:ship_3}.}