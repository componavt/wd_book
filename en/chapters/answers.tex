...
\begin{exercise}
	\label{answer:ship_2}
	\newthought{Based on the graph of the dependence of ships and military operations (Fig. \ref{fig:ships_by_country_and_conflict}), which country has the most values of wars associated with ships?
	\begin{itemize}
	  \item Soviet Union
	  \item Russia
	  \item Russian EMpire
...
\begin{exercise}
	\label{answer:ship_3}
	\newthought{Based on the graph of the dependence of ships and military operations (Fig. \ref{fig:ships_by_country_and_conflict}), which war accounts for most of the values of ships?
	\begin{itemize}
...
\begin{exercise}
	...
	\newthought{Find the "Guinness ship" (to choose from: the largest, the longest, the most capacious).}
\end{exercise}

\newthought{Possible solution: \href{https://en.wikipedia.org/wiki/Seawise_Giant}{Seawise Giant}}

\newthought{Other possible solutions from Wikidata. The data may differ beacouse of imcopmlintess of wikidata objects' properties, see the listings \ref{lst:long_ship} and \ref{lst:wide_ship}.}
...
\begin{exercise}
	...
	\newthought{Output pictures of those ships, about which the film were shot. If there are no such, then those ships, about which the books were written}\\
...
Submarine \href{https://ru.wikipedia.org/wiki/К-19}{K-19} was filmed in \href{https://en.wikipedia.org/wiki/K-19:_The_Widowmaker}{K-19: The Widowmaker}.  Source: \href{https://commons.wikimedia.org/wiki/File:K-19.jpg}{https://commons.wikimedia.org/wiki/File:K-19.jpg}, Norman Polamar Cold War Submarines.



\begin{exercise}
	\label{answer:ship_ex_3}
	\newthought{Find \href{https://en.wikipedia.org/wiki/List_of_museum_ships}{the museum ship}}
\end{exercise}
