...
\begin{lstlisting}[ language=SPARQL, breaklines=true, 
                    caption={Dates of foundation of domestic aircraft factories\\\hspace{\textwidth}
						Received 15 domestic aircraft factories with the date of foundation, 2021.
...
Which aircraft is shown in Fig. \ref{fig:airship_question_answers_aircraft_en_2}?

\end{exercise}

The aircraft shown in Fig. \ref{fig:airship_question_aircraft_en_2} is an airship. 
