...
\begin{exercise}
	...
	The flag of the Moscow region corresponds to the above description. The answer to the question can be checked by executing the following SPARQL query (query~\ref{lst:subjects_of_Russia_3_q})
\end{exercise}	
	\begin{lstlisting}[ language=SPARQL, numbers=none,
	caption={\href{https://w.wiki/4bKd}{Flags of the subjects of Russia.}\protect\footnotemark},
...
\end{lstlisting}
\footnotetext{86 records were received in 2021. Link to SPARQL query: \href{https://w.wiki/4bKd}{https://w.wiki/4bKd}}  
	
\small{Question on the page~\pageref{lst:oblast-of-Russia}.}

\begin{exercise}
	\label{answer:subjects_of_Russia_1}
	Such a region is Karelia. It is located in the north-west of Russia, originated in \num{1920}. It borders the Leningrad, Vologda, Arkhangelsk and Murmansk regions. It also borders Finland to the west.  The answer to the question can be checked by executing the following SPARQL query (query \ref{lst:sharesBorderWith}).
\end{exercise}	
...
\end{marginfigure}
	...
	\begin{lstlisting}[ language=SPARQL, numbers=none,
	caption={\href{https://w.wiki/4bKg}{Borders and date of origin of the subjects of the Russian Federation}\protect\footnotemark},
...
\end{lstlisting}
\footnotetext{485 records were received in 2021. Link to SPARQL query: \href{https://w.wiki/4bKg}{https://w.wiki/4bKg}}  
	
\small{Question on the page~\pageref{lst:sharesBorderWith-oblast-of-Russia}.}

\begin{exercise}
	\label{answer:subjects_of_Russia_2}
	Now the Russian Federation includes: the Republic of Adygea, Kamchatka Krai, Chukotka Autonomous Okrug, not included~--- Chita region. The answer to the question can be checked by executing the following SPARQL query (query \ref{lst:subjects_of_Russia_2_q}).
\end{exercise}	
	\begin{lstlisting}[ language=SPARQL, numbers=none,
	caption={\href{https://w.wiki/4bKi}{List of subjects of Russia}\protect\footnotemark},
...
\end{lstlisting}
\footnotetext{86 records were received in 2021. Link to SPARQL query: \href{https://w.wiki/4bKi}{https://w.wiki/4bKi}}  
