...
Any of the three options can be used thanks to the explanations we have in the official documentation\sidenote[]{See installation guide Pywikibot: \url{https://w.wiki/4CsU}} 
...
by pressing\marginnote[0.5cm]{Installation documentation: \url{https://www.mediawiki.org/wiki/Manual:Pywikibot/Installation}}
...
\marginnote[2\baselineskip]{There in Wikidata are two rivers with the same name, which is ``Obnitsa'', one of them is in Poland, while the another in Serbia. Objects with the same names are easily distinguishable by numbers in Wikidata: \wdqName{Obnitsa}{16583338} and \wdqName{Obnitsa}{959190}.}
%
\begin{lstlisting}[ language=Python,
...
First, we go to Wikidata Query Service \href{https://query.wikidata.org/}{WDQS}\footnote[][0pt]{%
