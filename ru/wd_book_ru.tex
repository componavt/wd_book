...
%\usepackage[pdftex,pdfpagelabels,hyperindex,hyperfigures]{hyperref}.
\usepackage[unicode]{hyperref}
\hypersetup{bookmarks=true,
            pdfpagelabels=true,
            hyperindex=true,
            hyperfigures=true,
            pdfauthor={Крижановский и др.},
            pdftitle={Программирование Викиданных},
            pdfsubject={Wikidata Programming},
            pdfkeywords={Wikidata, SPARQL, Wikidata Query Service, WDQS},
            }
...
\setlist[enumerate,1]{leftmargin=24pt}  % https://tex.stackexchange.com/a/104354/99685
...
% Владимир Александрович Плеханов - Vladimir Plekhanov 
...
% Creating table cells spanning multiple rows
\usepackage{multirow}
...
%%%\includepdf[pages={1},noautoscale]{./page1.pdf}
%%%\includepdf[pages={1-3},noautoscale]{./page2-4Sierra.pdf}
%%%\iffalse
...
% r.5 contents
\pdfbookmark[1]{Оглавление}{SomeAnchor}
\tableofcontents
...
\printindex
\addcontentsline{toc}{chapter}{\indexname} % see tufte-common.def
