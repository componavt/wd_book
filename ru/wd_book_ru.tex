...
% \wdproperty{607, conflict} = \href{https://www.wikidata.org/wiki/Property:P607}{conflict (P607)}
\newcommand{\wdProperty}[2]{\href{https://www.wikidata.org/wiki/Property:P#1}{#2 (#1)}}
...
\author[Крижановский А. А., Трубина Е. Д., Балакирева М. С., Меньшикова Е. А., Потес А. С.]{Крижановский Андрей, Трубина Елизавета, Балакирева Мария, Меньшикова Екатерина, Потес Артём}
...
\input{./chapter/listings_about.tex}
%\input{./chapter/prowd.tex}
...
\part{Математики, рейтинги и академии}

\input{./math/age_academy/academy.tex}
...
\begin{figure*}[p]
\fbox{\includegraphics[width=0.45\linewidth]{graphics/temp/vdqi-title.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{graphics/temp/ei-title.pdf}}
\\\vspace{\baselineskip}
