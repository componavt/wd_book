...
\documentclass[nofonts,justified,nobib,openany]{tufte-book}% good in Ubuntu
...
\usepackage{enumitem}% https://tex.stackexchange.com/a/86055/99685
...
\@ifundefined{c@draft}{
  \newcounter{draft}
  \setcounter{draft}{0} % 0 --- clean release version, without any comments, 
...
%    \partname~\thepart%
    ...
    \newline%
    \hfil\pgfornament[width=4cm]{75}\hfil%
    \newline%
    #1%
    }
...
% Do not use package caption in Tufte LaTeX!
% \captionof in minipage, when Two figures side by side, https://tex.stackexchange.com/a/57436/99685
%\usepackage{caption}
...
%\makeatletter
%\renewcommand{\fnum@figure}{Рис.~\thefigure.}
%\makeatother
%\captionof{listings}{#2\label{#3}
\renewcommand\lstlistingname{Запрос}% Listing -> Query
%\renewcommand{\lstlistingname}{Запрос}
%\captionsetup[lstlisting]{% remove semicolon Query: N -> Query. N
%  labelsep=period
%}
