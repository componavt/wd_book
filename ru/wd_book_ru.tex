...
{\texttt{Обитаемый остров\\Аркадий и Борис Стругацкие}}
...
{\texttt{Рэсси~--- неуловимый друг\\Евгений Велтистов}}
\vspace{42px}
...
\textit{\textbf{Издание посвящается всем изобретателям SPARQL-скриптов~--- программистам будущего, 
