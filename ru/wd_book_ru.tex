...
\documentclass[nofonts,justified]{tufte-book}
...
\usepackage[scaled=.65]{PTMono}

\usepackage[babel=true]{microtype} % see https://tex.stackexchange.com/a/355726/99685

% Select font you like
\usepackage{paratype} % very good
