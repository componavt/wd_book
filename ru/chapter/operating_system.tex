...
\index{График!TimeLine / Часть таймлайна выпуска операционных систем на 2020 год.}
\begin{figure*}[h!]
...
\index{SPARQL!COUNT / Список языков программирования и количество написанных на них ОС}
\begin{lstlisting}[ language=SPARQL, 
...
\index{График!BarChart / Количество операционных систем, написанных на языках программирования (данные на 2020 год.)}
\begin{figure*}[h!]
...
\index{SPARQL!COUNT / Список ОС с количеством пограммного обеспеечния для него}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT / Список языков программирования с количеством написанного для него ПО}
\begin{lstlisting}[ language=SPARQL, 
...
\index{График!BarChart / Языки программирования и количества ОС, под которыми работают программы, написанные на них 2020 год.}
\begin{figure*}[h!]
