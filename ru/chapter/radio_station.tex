...
\answerVlad{Ответ: ... (Егор, здесь пишите мне ответ, что всё сделано, или пишите в чём загвоздка).
(Моё задание выше оставляйте, не стирайте, чтобы я видел, что было задано.)}
...
\end{lstlisting}%
\footnotetext{Получено: 120 радиостанций на 2024 год. 
...
\end{lstlisting}%
\footnotetext{Получено: 128 радиостанций на 2024 год. 
...
Данная таблица даёт нам представление того, 
...
Популярными социальными сетями среди радиостанций, СМИ и вещательных каналов на 2024 год стали: 
...
Таким образом, самой популярной социальной сетью для СМИ стал ВКонтакте.
