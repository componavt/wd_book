...
Радиостанции --- комплекс устройств и сооружений, служащих для подготовки программ радиовещания. Эта глава посвящена исследованию программ радиовещния на основе Викиданных. Для исследования спроектированы SPARQL-запросы, работающие с объектами Викиданных типа <<\wdqName {радиостанции} {14350}>> и свойством <<\wdProperty{экземпляр}{31}>>. Получен список всех радиостанций, описанных в Викиданных. С помощью запросов получено количество радиостанций у различных стран, а также для определения подклассов радиостанций. Проделана работа для поиска радиостанций, вещательных каналов и СМИ по России, и по СССР, их тематик и аккаунтов в социальных сетях.
...
\end{lstlisting}%
\footnotetext{Получено: \num{118} результатов на 2024 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/9hkz}{https://w.wiki/9hkz}.}
...
\end{lstlisting}%
\footnotetext{Получено: 31 результат на 2024 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/9hm7}{https://w.wiki/9hm7}.}

Всего в мире около двухсот стран (смотри главу <<\nameref{ch:country}>> на странице~\pageref{ch:RussiaNotCountryPPS}), но запрос~\ref{lst:number_of_radio_stations} нашёл только 31 страну, в которых есть радиостанции. Поскольку радиостанции есть в каждой стране мира, то результаты запроса говорят о неполноте Викиданных.

\newpage

Мы переделали запрос~\ref{lst:number_of_radio_stations}, изменив в нём <<\wdProperty{495}{страна происхождения}>> на <<\wdProperty{17}{государство}>> в запросе~\ref{lst:number_of_radio_stations_for_each_country}. Изменения были внесены, потому что <<\wdProperty{495}{страна происхождения}>> совсем не подходит для поиска стран, с помощью этого свойства находятся музыкальные композиции, виды спорта и тд. 
...
\footnotetext{Получено: \num{209} результатов на 2024 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/9hmS}{https://w.wiki/9hmS}. }
...
\footnotetext{Получено: \num{23} результата на 2024 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/9hmw}{https://w.wiki/9hmw}. }
