...
\index{SPARQL![]!безымянная переменная~--- последовательность свойств}
...
В нашем случае с кораблями свойство \wdProperty{137}{operator} (строка~8 \TODO в~запросе~\ref{lst:ships_in_war_ru}) 
было успешно заменено новым 
свойством \wdProperty{8047}{country of registry} (строка~\TODO в~запросе~\TODO
