...
\end{lstlisting}
\footnotetext{\href{https://w.wiki/koL}{SPARQL-запрос}, 19 820 записей (2017), 50 681 записей (2020).}
...
\end{lstlisting}
\footnotetext{\href{https://w.wiki/koW}{SPARQL-запрос} - было 105 результатов, 07:38, 6 ноября 2017; 86 записей (2020).}