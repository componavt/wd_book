...
\end{lstlisting}
\footnotetext{Найдено 107 кораблей в 2017 году, 578 кораблей в 2021 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/wXA}{https://w.wiki/wXA}}


\section{Полнота Викиданных}

\label{question:ship_1}
\marginnote{Найти <<корабль Гиннесса>>. На выбор: самый большой, самый длинный, самый вместительный и т. д.\\ Ответ на странице~\pageref{answer:ship_1}.}
...
\marginnote{Найдите изображения кораблей, заснятых в кино или описанных в книгах. Ответ на странице~\pageref{answer:ship_3}}
...
Составим список отечественных кораблей, участвовавших в каких-либо конфликтах с помощью скрипта в листинге~\ref{lst:ships_in_war_ru}.
...
\marginnote[-10.0cm]{Здесь используется функция FILTER, чтобы избежать появления петель и дублирующих рёбер на графе.}
\marginnote[-4.0cm]{Здесь используется ``p:/ps:'' из-за наличия нескольких значений у свойства \href{https://www.wikidata.org/wiki/Property:P31}{экземпляр (P31)} у страны. Для справки см. главу~\ref{ch:RussiaNotCountryPPS} на странице~\pageref{ch:RussiaNotCountryPPS}.}
