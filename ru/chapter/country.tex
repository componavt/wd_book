...
\sidenote{%
    ...
    а другие редакторы отвечают. Пользуйтесь этим форумом.%
%
...
\marginnote{%
    ...
    \noindent См. ответ~\ref{answer:official_language} на с.~\pageref{answer:official_language}.
}
...
\newpage
\index{SPARQL!FILTER!Страны без русских этнохоронимов}
\index{SPARQL!MINUS!Страны без русских этнохоронимов}
\begin{lstlisting}[ language=SPARQL, 
...
\index{График!BubbleChart!Страны с разными формами правления}
\begin{lstlisting}[ language=SPARQL, 
...
\begin{figure*}
    \centering
    \includegraphics[width=0.66\linewidth]{./chapter/country/Bubble_chart_forms_of_government_countries_according_to_Wikidata.png}
