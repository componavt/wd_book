...
Почти пустой и малоинформативной страной по данным ProWD является: \wdqName{Монгольская империя}{12557}.
...
\index{График!Map / Пузырьковая диаграмма по числу побратимов у страны}
\begin{lstlisting}[ language=SPARQL, 
