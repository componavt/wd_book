...
\footnotetext{
Используемые в SPARQL-запросах объекты:
\begin{itemize}
	\item\href{https://www.wikidata.org/wiki/Q9143}{programming language}
	\item\href{https://www.wikidata.org/wiki/Q899523}{object-based language}
\end{itemize}
}
\footnotetext{
Используемые в SPARQL-запросах свойства:
\begin{itemize}
	\item\href{https://www.wikidata.org/wiki/Property:P737}{influenced by}
	\item\href{https://www.wikidata.org/wiki/Property:P178}{developer}
	\item\href{https://www.wikidata.org/wiki/Property:P275}{copyright license}
	\item\href{https://www.wikidata.org/wiki/Property:P31}{instance of}
	\item\href{https://www.wikidata.org/wiki/Property:P1195}{file extension}
	\item\href{https://www.wikidata.org/wiki/Property:P159}{headquarters location}
	\item\href{https://www.wikidata.org/wiki/Property:P625}{coordinate location}
	\item\href{https://www.wikidata.org/wiki/Property:P69}{educated at}
	\item\href{https://www.wikidata.org/wiki/Property:P19}{place of birth}
	\item\href{https://www.wikidata.org/wiki/Property:P106}{occupation}
\end{itemize}
}
...
\begin{table}
		\begin{tabular}{c c c c}
			\includegraphics[width=3cm]{./chapter/programming_language/task_2_logo_1.PNG} & \includegraphics[width=3cm]{./chapter/programming_language/task_2_logo_2.PNG} & \includegraphics[width=3cm]{./chapter/programming_language/task_2_logo_3.PNG} & \includegraphics[width=3cm]{./chapter/programming_language/task_2_logo_4.PNG}\\
		\end{tabular}
\end{table}
