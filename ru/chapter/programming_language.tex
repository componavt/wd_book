...
\index{SPARQL!MINUS!Список свободных ЯП}
\begin{lstlisting}[
	language=SPARQL,
...
\centering
    ...
    \caption[Число форматов файлов для языков программирования, 2017 год.]{Пузырьковая диаграмма 
            с числом форматов файлов исходного кода для разных языков программирования, 2017 год. 
