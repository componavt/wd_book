...
\begin{marginfigure}[0\baselineskip]
	\includegraphics[width=1\textwidth]{./chapter/musical_composition/Graph_music_by_composers_from Russia_and_USA.png}
...
\answerVlad{Ответ: Добавил новый рисунок~\ref{fig:RussianAndUSAComposers10years} и перенес рис.~\ref{fig:CompareRuMusComposerWithout} с пояснениями к нему выше, что бы сохранить логическую последовательность рисунков с запросами.}
...
получим запрос~\ref{lst:music_in_genres_1960-1990}. 
...
ORDER BY DESC (?count)
\end{lstlisting}%
\footnotetext{Получено: \num{885} жанров на 2024 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/9$Hw}{https://w.wiki/9\$Hw}.}
...
\answerVlad{Ответ: Изменил запросы и рисунки. Также изменил описание со сравнением.}
...
...
\end{lstlisting}%
\footnotetext{Получено: \num{1419} подкласс на 2024 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/9$Kx}{https://w.wiki/9\$Kx}.}

Изобразим рузультаты обоих скриптов на круговой диаграмме (рис.~\ref{fig:Genre_Chart_1960_—_1990_and_2000_—_2030}).

\begin{marginfigure}[0\baselineskip]
	\includegraphics[width=1\textwidth]{./chapter/musical_composition/Genre_Chart_1960_—_1990_and_2000_—_2030.png}
	\caption{Круговая диаграмма музыкальных жанров за <<первую волну>> 1960-1990 годы и <<вторую волну>> 2000-2030 годы}%
