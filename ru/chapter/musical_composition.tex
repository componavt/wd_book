...
входит объекта ``incipit (Q1161138)'' (<<начальные слова>>) 
и объект Маска (wd:Q1907293), то есть это не музыкальные вещи. 
Нужно добавить в запрос исключение этих двух объектов, 
вижу два варианта: или функция FILTER (неравенство) или MINUS. Примеры скриптов с MINUS 
...
также обратите внимание читателя, 
