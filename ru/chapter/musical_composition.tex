...
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/4$Q$}{SPARQL-запрос},135466 музыкальных произведений.}
...
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/4$R3}{SPARQL-запрос}, на 1 апреля 2022 года запрос выдает 135466 музыкальных произведений.}
