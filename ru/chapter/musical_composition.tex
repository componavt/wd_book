...
достойных упоминания в энциклопедии. 
...
Можем увидеть, что количество музыкальных произведений, написанных композиторами из Росии и СССР за каждые 10 лет 
...
на графике~\ref{fig:RussianComposers10years}.

Ещё есть график~\ref{fig:RussianMusic10years}
