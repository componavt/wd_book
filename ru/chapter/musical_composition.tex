...
\end{lstlisting}%
\footnotetext{Получено: \num{5495} записи на 2017 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/85dRG}{https://w.wiki/85dR}.}
...
\end{lstlisting}%
\footnotetext{Получено: \num{2887} музыкальных произведений за период 2018-2023 года. Ссылка на SPARQL-запрос: \href{https://w.wiki/8GLn}{https://w.wiki/8GLn}.}
...
\begin{marginfigure}[0\baselineskip]
	\includegraphics[width=1\textwidth]{./chapter/musical_composition/chart.png}
...
\footnotetext{Ссылка на статью: \href{https://ru.wikipedia.org/wiki/Общественное_достояние#Общественное_достояние_в_России}{https://ru.wikipedia.org/wiki/Общественное_достояние#Общественное_достояние_в_России}.}
