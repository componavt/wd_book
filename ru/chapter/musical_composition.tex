...
\end{lstlisting}%
\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/5$CG}{SPARQL-запрос}. \num{5494} записи в 2017 году.}
...
ORDER BY DESC (?count)
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/5$BV}{SPARQL-запрос}, \num{161} подкласса музыкальных композиций на 2022 год.}
...
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/5$BT}{SPARQL-запрос}, \num{145046} музыкальных произведений.}
...
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/5$BP}{SPARQL-запрос}, на 1 апреля 2022 года запрос выдает \num{145046} музыкальных произведений.}
...
ORDER BY (?date)
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/7wHy}{SPARQL-запрос}}
...
ORDER BY DESC (?count)
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/6Vx5}{SPARQL-запрос}}
...
ORDER BY DESC (?count)
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/6Vx6}{SPARQL-запрос}}
...
ORDER BY (?date)
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/6UUF}{SPARQL-запрос}}
...
\end{lstlisting}%
\footnotetext{Ссылка на \href{https://w.wiki/5$Bf}{SPARQL-запрос}, 3771 запись.}
...
\footnotetext{Получено \num{773} записи. Ссылка на \href{https://w.wiki/5$CK}{SPARQL-запрос}}
