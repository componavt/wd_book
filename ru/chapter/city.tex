...
\fcolorbox{gray}{gray}{\includegraphics[width=\linewidth]{./chapter/city/Logarithm_of_the_number_of_cities_having_given_number_of_sister_cities_according_to_Wikidata,_2020.png}}%
  ...
  \caption[Зависимость числа городов от числа имеющихся побратимов на логарифмической шкале, 2020 год.]{Зависимость числа городов всего мира (N) от числа имеющихся у этих городов побратимов (S) в логарифмической шкале, 2020 год.}%
...
\begin{table}
  ...
  \begin{tabular}{| c | l | r | r |}
   ...
   \midrule
    ...
    \caption[Страны с наибольшим числом побратимов с городами Германии, 2020 год.]{Список первых 10 стран, имеющих больше всего побратимов с городами Германии на 2020 год.}
