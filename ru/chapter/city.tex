...
\index{SPARQL!COUNT!Количество городов без побратимов}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Список городов по числу побратимов}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Число городов с побратимами}
\index{График!LineChart!Число городов мира по числу побратимов}
\begin{lstlisting}[ language=SPARQL, 
...
\index{График!LineChart!Зависимость числа городов России от числа побратимов}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Список стран по числу побратимов}
...
\index{SPARQL!COUNT!Страны с побратимами в Германии}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Соседи России по числу побратимов}
\index{SPARQL!NOT IN!Соседи России по числу побратимов}
\index{SPARQL!FILTER!Соседи России по числу побратимов}
\index{SPARQL!OPTIONAL!Соседи России по числу побратимов}
\index{SPARQL!BIND!Соседи России по числу побратимов}
\index{SPARQL!IF!Соседи России по числу побратимов}
\index{График!Map!Соседи России по числу побратимов}
\begin{lstlisting}[ language=SPARQL, 
