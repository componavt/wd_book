...
\end{lstlisting}
\footnotetext{Получено \num{4046} городов мира с побратимами в 2020 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/jg$}{https://w.wiki/jg\$}}         
...
ORDER BY DESC(?sisterCount) # Sorting by number of sister cities
\end{lstlisting}
\footnotetext{Получено 82 города России с побратимами в 2020 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/pM7}{https://w.wiki/pM7}}  
...
\fcolorbox{gray}{gray}{\includegraphics[width=\linewidth]{./chapter/city/Map_of_closest_neighbours_of_Russia_by_number_of_sister_cities,_2020.png}}
	...
	\caption{Карта ближайших соседей России по числу городов-побратимов, 2020.}
