...
\begin{task}
    ...
    \newthought{В 1960х совершено 11 запусков, в 1970х 34 запуска и в 1980х 29 запусков}. 
    Скрипт построения графика запуска космических аппаратов в нашей стране, начиная с 1960-х годов, представлен в листинге~\ref{lst:launch_USSR}.
    \begin{lstlisting}[ language=SPARQL, numbers=none, caption={{\href{https://w.wiki/4QGX}{Запуски космический кораблей в СССР и России}}\protect\footnotemark}, label=lst:launch_USSR, ]
    ...
    \small{Вопрос на с.~\pageref{lst:imageRU}.}
\end{task}

\begin{task}
    \label{answer:launches_world}
    \newthought{Наибольшее число запусков в указанные промежутки времени зафиксированов 2000х, а наименьшее в 1970х}
    ...
    \small{Вопрос на с.~\pageref{lst:imageALL}.}
\end{task}

\begin{task}
    \label{answer:launches_country}
    \newthought{Согласно Викиданным наибольшее число запусков (более 10 в год) имеют США и Индия}
    Скрипт построения графика запусков космических кораблей странами-рекордсменами представлен в листинге ~\ref{lst:topLaunch}:
    \begin{lstlisting}[ language=SPARQL, numbers=none, caption={{\href{https://w.wiki/4bEu}{Запуски космических кораблей в мире}}\protect\footnotemark}, label=lst:topLaunch, ]
    #defaultView:BarChart
    SELECT ?year (COUNT(?object) AS ?count) ?countryLabel 
    WHERE {
    ...
    GROUP BY ?year ?country ?countryLabel
    \end{lstlisting}
    \footnotetext{Найдено \num{172} результата в 2021 г. Ссылка на SPARQL-запрос: \href{https://w.wiki/4bLz}{https://w.wiki/4bLz}}
    \small{Вопрос на с.~\pageref{lst:imageALL}.}
\end{task}
