...
\begin{task}
	...
	\small{Вопрос на с.~\pageref{lst:list_of_country_instance_of_}.}
\end{task}
...
\newthought{Список стран происхождения операционных систем можно получив выполнив следующий SPARQL-запрос (листинг \ref{lst:os_logos}).}
