...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{task}
Добавим в запрос~\ref{lst:music_in_each_subclass} команду \lstinline|FILTER (?type != wd:Q1161138 && ?type != wd:Q1907293)| исключающий объекты ``incipit (wd:Q1161138)'' и ``Маска (wd:Q1907293)''.
 \begin{lstlisting}[ 
            language=SPARQL, 
            numbers=none, 
...
\footnotetext{Получено: 7 подклассов музыкальных композиций на 2024 год. Ссылка на~SPARQL-запрос: \href{https://w.wiki/9XVJ}{https://w.wiki/9XVJ}.}
    ...
    \small{\AnswerBackref Вопрос на с.~\pageref{question:music_comp}.}
...
\footnotetext{Получено: 87 уникальных композиций на 2024 год. 
    ...
    \small{\AnswerBackref Вопрос на с.~\pageref{question:music_unique}.}
...
Мы установили промежуток с 1960 по 1970, потому что это основные годы активности группы The Beatles/
...
\begin{marginfigure}
	...
	\caption[Гистограмма количества музыкальных композиций The Beatles с 1960 по 1970 годы]{Ежегодное количество музыкальных композиций, выпускаемых группой The Beatles с 1960 по 1970 годы}%
 	\label{fig:ThebeatlesBubbleChart}%
\end{marginfigure}

    \small{\AnswerBackref Вопрос на с.~\pageref{question:TheBeatles_quest}.}
