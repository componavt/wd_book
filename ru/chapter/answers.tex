...
\end{lstlisting}
\footnotetext{Получено 15 отечественных авиазаводов с датой основания, 2021 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/t4T}{https://w.wiki/t4T} }
...
\begin{task}
	\href{https://ru.wikipedia.org/wiki/Гремящий_(эсминец,_1937)}{Гремящий (эсминец, 1937)}.
...
\begin{task}
	...
	\newthought{Один из воможных ответов: \href{https://en.wikipedia.org/wiki/Seawise_Giant}{Seawise Giant}}

	\newthought{Примеры возможных решений через wikidata. Данные могут отличаться от ответа выше из-за неполноты информации об объектах Викиданных, см. в листингах \ref{lst:long_ship} и \ref{lst:wide_ship}.}
\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/ugH}{Самый длинный корабль}}\protect\footnotemark}, label=lst:long_ship, ]
...
\end{lstlisting}
\footnotetext{Найден \href{https://www.wikidata.org/wiki/Q48817670}{NMS Mircea} в январе 2021 г., длина \num{36} м. Ссылка на SPARQL-запрос: \href{https://w.wiki/ugH}{https://w.wiki/ugH}.}

\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/ugG}{Самый широкий корабль}}\protect\footnotemark}, label=lst:wide_ship, ]
...
\end{lstlisting}
\footnotetext{ Найден \href{https://www.wikidata.org/wiki/Q1156392}{Project Habakkuk} в январе 2021 г., ширина \num{180} м. Ссылка на SPARQL-запрос: \href{https://w.wiki/vT2}{https://w.wiki/vT2}.}
...
\begin{task}
	...
	Решение:
	\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/vSy}{Изображения кораблей, которые снимались в фильмах}}\protect\footnotemark}, label=lst:wide_ship, ]
...
WHERE
{
	...
	\end{lstlisting}
	\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/vSy}{https://w.wiki/vSy}.}

	\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/vTE}{Изображения кораблей, о которых писали в книгах}}\protect\footnotemark}, label=lst:wide_ship, ]
SELECT DISTINCT ?image
WHERE
{
	...
	\end{lstlisting}
	\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/vTE}{https://w.wiki/vTE}.}
\end{task}


\begin{task}
	\label{answer:ship_ex_3}
	\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/ugG}{Корабли-музеи}}\protect\footnotemark}, label=lst:museum_ship, ]
...
WHERE
{
	...
	\end{lstlisting}
	\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/uhG}{https://w.wiki/uhG}.}
\end{task}
