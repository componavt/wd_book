...
\begin{task}
	...
	\begin{lstlisting}[ language=SPARQL, 
	caption={\href{https://w.wiki/4ZUY}{Флаги субъектов России.}\protect\footnotemark},
...
WHERE
{
  ...
  ?subject wdt:P41 ?flag
	...
	\end{lstlisting}
	\footnotetext{Получено 86 записей в 2021 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/4ZUY}{https://w.wiki/4ZUY}}  
...
\begin{task}
	...
	\newthought{Карелия - это субъект, расположенный на северо-западе России, возник в \num{1923} году. Он граничит с Ленинградской, Вологодской, Архангельской и Мурманской областью. Также граничит с Финляндией на западе.  Ответ на вопрос можно проверить, выполнив следующий SPARQL-запрос (листинг \ref{lst:sharesBorderWith}).}
...
\end{marginfigure}
	...
	\begin{lstlisting}[ language=SPARQL, 
	caption={\href{https://w.wiki/4Z9s}{Границы и дата возникновения по субъектам}\protect\footnotemark},
...
WHERE
{
  ...
  ?subject wdt:P571 ?year
	...
	\end{lstlisting}
	\footnotetext{Получено 485 записей в 2021 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/4Z9s}{https://w.wiki/4Z9s}}  
...
\begin{task}
	...
	\newthought{На текущий момент входят в состав Российской Федерации: Республика Адыгея, Камчатский край, Чукотский автономный округ, не входит - Читинская область. Ответ на вопрос можно проверить, выполнив следующий SPARQL-запрос (листинг \ref{lst:subjects_of_Russia_2_q}).}
	
	\begin{lstlisting}[ language=SPARQL, 
	caption={\href{https://w.wiki/4ZAK}{Список субъектов России.}\protect\footnotemark},
...
WHERE
{
  ...
  SERVICE wikibase:label { bd:serviceParam wikibase:language "ru" }
	...
	\end{lstlisting}
	\footnotetext{Получено 86 записей в 2021 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/4ZAK}{https://w.wiki/4ZAK}}  
