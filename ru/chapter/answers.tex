...
\end{lstlisting}
\footnotetext{Самым длинным кораблем оказался \href{https://www.wikidata.org/wiki/Q48817670}{NMS Mircea} длиной в  \num{36} метров. Ссылка на SPARQL-запрос: \href{https://w.wiki/vTt}{https://w.wiki/vTt}.}
...
\begin{task}
	...
	Решение:
	\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/vf9}{Изображения кораблей, которые снимались в фильмах}}\protect\footnotemark}, label=lst:wide_ship, ]
...
WHERE
{
	...
	\end{lstlisting}
	\footnotetext{Найдено 5 изображений кораблей, снимавшихся в фильмах, 2021 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/vf9}{https://w.wiki/vf9}.}

	\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/vfA}{Изображения кораблей, о которых писали в книгах}}\protect\footnotemark}, label=lst:wide_ship, ]
SELECT DISTINCT ?image
WHERE
{
	...
	\end{lstlisting}
	\footnotetext{Найдено 8 изображений кораблей, о которых было написано в книгах, 2021 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/vfA}{https://w.wiki/vfA}.}
