...
и <<Вымпел>>~--- в 1949 году.
    Ответ на вопрос можно получить, выполнив SPARQL-запрос, представленный на листинге~\ref{lst:aircraft_company_foundation_date_lst}}. 
    
	\begin{lstlisting}[ language=SPARQL, 
    caption={\href{https://w.wiki/t4T}{Даты основания отечественных авиазаводов}\protect\footnotemark}, label=lst:aircraft_company_foundation_date_lst, ]
...
\begin{task}
	\href{https://ru.wikipedia.org/wiki/Гремящий_(эсминец,_1937)}{Гремящий (эсминец, 1937)}. См. рисунок \ref{fig:grem_answer}.
	...
	\begin{marginfigure}[0.0cm]
		...
		\caption{Почтовая марка с изображением эсминца \href{https://ru.wikipedia.org/wiki/Гремящий_(эсминец,_1937)}{Гремящий}.}%
...
\end{lstlisting}
\footnotetext{Найден \href{https://www.wikidata.org/wiki/Q1156392}{Project Habakkuk} в январе 2021 г., ширина \num{180} м. Ссылка на SPARQL-запрос: \href{https://w.wiki/vTx}{https://w.wiki/vTx}.}


\small{Задание на с.~\pageref{ship_tasks}.}
\end{task}
