...
\begin{task}
	...
	\begin{marginfigure}[0.0cm]
		...
		\caption{Почтовая марка с изображением эсминца \href{https://en.wikipedia.org/wiki/Soviet_destroyer_Gremyashchy_(1937)}{Гремящий}.}%
...
\begin{task}
	\label{answer:ship_3}
	\newthought{Один из воможных ответов:  \Wikiref{Seawise Giant}}
