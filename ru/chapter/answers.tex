...
\begin{task}
	...
	\newthought{Найти "корабль Гиннесса" (на выбор: самый большой, самый длинный, самый вместительный и т. д.).}
	\newthought{Один из воможных ответов: \href{https://en.wikipedia.org/wiki/Seawise_Giant}{Seawise Giant}}

	\newthought{Примеры возможных решений через wikidata. Данные могут отличаться от ответа выше из-за неполноты информации об объектах wikidata, см. в листингах \ref{lst:long_ship} и \ref{lst:wide_ship}.}
\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/ugH}{Самый длинный корабль на wikidata}}\protect\footnotemark}, label=lst:long_ship, ]
...
\end{lstlisting}
\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/ugH}{https://w.wiki/ugH}. Найден \href{https://www.wikidata.org/wiki/Q48817670}{NMS Mircea} в январе 2021 г., длина \num{36} м.}

\begin{lstlisting}[ language=SPARQL, caption={{\href{https://w.wiki/ugG}{Самый широкий корабль на wikidata}}\protect\footnotemark}, label=lst:wide_ship, ]
...
\end{lstlisting}
\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/vT2}{https://w.wiki/vT2}. Найден \href{https://www.wikidata.org/wiki/Q1156392}{Project Habakkuk} в январе 2021 г., ширина \num{180} м.}
...
\begin{task}
	...
	\newthought{Вывести фотографии тех кораблей, про которые снимали кино. Если таких не найдётся, тогда те корабли, о которых писали в книгах.}\\
...
\begin{task}
	...
	\newthought{Вывести \href{https://ru.wikipedia.org/wiki/Список_кораблей-музеев}{корабли-музеи}}
