...
\begin{task}
	...
	\newthought{ Количество административно-территориальных единиц у \href{https://w.wiki/mzN}{Латвии} составляет 119, у \href{https://w.wiki/mzP}{Таиланда} 77, у \href{https://w.wiki/mzR}{Дании} 5, а у \href{https://w.wiki/myt}{России} 81. Ответ на вопрос также можно получить, выполнив следующий SPARQL-запрос (листинг \ref{lst:administrative_territorial_entity}).}
...
\begin{task}
	...
	\begin{enumerate}
		\item Монголия (\num{1.96} человек на квадратный километр), (рис. ~\ref{fig:flag_mongolia});
		\item Израиль (\num{437.79} человек на квадратный километр), (рис. ~\ref{fig:flag_israel});
		\item Корея (\num{513.14} человек на квадратный километр), (рис. ~\ref{fig:flag_kor});
		\item Сингапур (\num{8189.30} человек на квадратный километр), (рис. ~\ref{fig:flag_singapore}).
	\end{enumerate}	
	}
