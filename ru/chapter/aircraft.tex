...
\ruwiki{vDw}{Миг} & 1 января 1939 \\
\ruwiki{vE4}{Вымпел} & 18 ноября 1949 \\
\ruwiki{vDy}{Туполев} & 18 декабря 1939 \\
\ruwiki{vDz}{Сухой} & 1 января 1922 \\
\end{tabular}
\\
...
Теперь попытаемся ответить на вопрос выполняется ли \ruwiki{vDs}{Закон Парето} относительно числа моделей самолётов?
...
\index{Самолёты!Определения!Закон Парето}
По графику~\ref{fig:Pareto_principle_diargam} видно, что 80\% всех выпущенных самолётов приходится на 16 различных моделей самолётов, что составляет 9,2\% от общего числа моделей. Закон Парето утверждает, что: \ruwiki{vDs}{«20\% усилий дают 80\% результата, а остальные 80\% усилий — лишь 20\% результата»}. Можно сделать вывод, что выполняется более сильный закон, чем принцип Парето относительно числа моделей самолётов.
...
\marginnote[-1cm]{Найдите соответствие между расположением штаб-квартиры компании и названием компании производителя самолётов в следующей таблице:
\\
\begin{tabular}{ l | l }
...
\begin{figure}[h!]
\centering
	\includegraphics[width=0.95\textwidth]{./chapter/aircraft/Manufacture-with-country_2017.png}
...
\marginnote[8pt]{Как называется воздушное судно, удерживаемое в воздухе огромным баллоном с горючим смертельно опасным газом, расположенным прямо над головами пассажиров?
\\
...
\begin{figure}[h!]
\centering
	\includegraphics[width=0.95\textwidth]{./chapter/aircraft/Manufacture-with-country_2020.png}
...
В категории Википедии \ruwiki{vF4}{<<Авиастроительные компании России>>}\marginnote{%
%
<<Авиастроительные компании России>>: \href{https://w.wiki/vF4}{https://w.wiki/vF4}%
%
