...
\begin{figure*}[h!]
    ...
    \fcolorbox{gray}{gray}{\includegraphics[width=0.6\linewidth]{./chapter/aircraft/Number_of_aircraft_produced_ru_2020.png}}%
...
\begin{figure*}[h!]
    ...
    \setlength{\fboxsep}{0pt}%
    \setlength{\fboxrule}{1pt}%
    \fcolorbox{gray}{gray}{\includegraphics[width=0.95\linewidth]{./chapter/aircraft/Pareto_principle_diargam.png}}%
...
\begin{minipage}[]{.46\linewidth}
	...
	\includegraphics[width=0.9\linewidth]{./chapter/aircraft/Manufacture-with-country_2020.png}
   	\captionof{figure}{Соотношение количества производителей воздушных судов по странам, 2020 год.}
	\label{fig:Manufacture_with_country_2020}
\end{minipage}
\end{fullwidth}%
...
%\begin{figure}[h!]
%\centering
%	\includegraphics[width=0.75\textwidth]{./chapter/aircraft/Manufacture-with-country_2017.png}
...
\fcolorbox{gray}{gray}{\includegraphics[width=0.7\linewidth]{./chapter/aircraft/airship-SSSR-V6.jpg}}%
    ...
    \caption[Неизвестное воздушное судно.]{Какое воздушное судно здесь изображено?\\
