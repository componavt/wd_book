...
\footnotetext{На 2017 год список содержал 300 записей, к 2020 году число записей увеличилось до 597. Ссылка на SPARQL-запрос: \href{https://w.wiki/t3n}{https://w.wiki/t3n}}
...
\end{lstlisting}
\footnotetext{Получен список, состоящий из 177 (на 2020 год) моделей воздушных судов. Ссылка на SPARQL-запрос: \href{https://w.wiki/t3p}{https://w.wiki/t3p}}
...
\footnotetext{Получен отфильтрованный по количеству выпущенных самолётов список, состоящий из 131 записи. Ссылка на SPARQL-запрос: \href{https://w.wiki/t3q}{https://w.wiki/t3q}}
\index{SPARQL!FILTER!Список выпущенных самолётов, в количестве более 10 штук}
\begin{lstlisting}[ language=SPARQL, caption={\href{https://w.wiki/t3q}{Список, включающий только те самолёты, которые были выпущены в количестве более 10 штук}\protect\footnotemark}, label=lst:lang3_1, ]
...
\begin{enumerate} 
  ...
  \footnotetext{Общее число выпущенных самолётов на 2020 год составляет \num{44151}. Ссылка на SPARQL-запрос: \href{https://w.wiki/t3s}{https://w.wiki/t3s}}
...
\footnotetext{Закон Парето: \href{https://clck.ru/JvaaU}{https://clck.ru/JvaaU}}
...
\end{lstlisting}
\footnotetext{Получено 39 записей в 2017 году, 46 записей в 2020 году. Ссылка на SPARQL-запрос: \href{https://w.wiki/t3t}{https://w.wiki/t3t}}
...
GROUP BY ?country ?countryLabel
\end{lstlisting}
\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/t3v}{https://w.wiki/t3v}}
...
\footnotetext{<<Авиастроительные компании России>>: https://cutt.ly/NhrKnWn}
