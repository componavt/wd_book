...
в~табл.~\ref{tab:human-settlement1} в~столбце <<Население>>. Ссылка на SPARQL-запрос: \url{https://w.wiki/4$8w}.}
...
Отметим, что если сложить численность разных типов городов в табл.~\ref{tab:human-settlement1}, 
