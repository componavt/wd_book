...
\index{SPARQL!SUM!Жителей в населённых пунктах по странам}
\index{SPARQL!GROUP BY!Жителей в населённых пунктах по странам}
...
\index{SPARQL!SUM!Доля людей в населённых пунктах}
\begin{lstlisting}[ language=SPARQL, 
...
\newpage
%\begin{fullwidth}
\index{SPARQL!COUNT!Классы, сопутствующие н. п. в свойстве <<экземпляр>>}
\index{SPARQL!FILTER!Классы, сопутствующие н. п. в свойстве <<экземпляр>>}
\index{SPARQL!MINUS!Классы, сопутствующие н. п. в свойстве <<экземпляр>>}
\lstset{numbers=left, firstnumber=1, frame=single}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Классы поселений с населением}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Профессии граждан России}
\lstset{numbers=left, firstnumber=1, frame=single}
\begin{lstlisting}[ language=SPARQL, 
...
\index{SPARQL!COUNT!Количество науч. сотрудников}
\begin{lstlisting}[ language=SPARQL, 
...
\newpage
%\begin{fullwidth}
    \index{График!BarChart!Рождения отечественных учёных в сёлах}
\begin{lstlisting}[ language=SPARQL, 
...
%\begin{fullwidth}
    \index{График!BarChart!Отечественные учёные, родившихся в сёлах}
\begin{lstlisting}[ language=SPARQL, 
