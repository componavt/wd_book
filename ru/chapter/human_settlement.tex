...
\end{lstlisting}%
\footnotetext{Число жителей в сельских поселениях в России в 2022 году представлено в таблицы~\ref{tab:human-settlement1} в столбце <<Население>>. Ссылка на SPARQL-запрос: \url{https://w.wiki/4$8w}}



А набор классов под номерами 8, 9, 20 и 55 в таблице~\ref{tab:human-settlement1} 
назовём \emph{городскими поселениями}. 
Подсчитаем суммарное число жителей в~городских поселениях в России\footnote{Получили \num{124,9} млн человек. Ссылка на SPARQL-запрос: \url{https://w.wiki/4$9$}}.
...
Таким образом, получили, что \num{55.6} млн человек живёт в сельских поселениях и \num{124.9} млн человек~--- в городских. 
Общее число составило $55,6 + 124,9 = 180,5$, при этом по по оценке Росстата в России было 145 млн человек в 2022 году. 
Получили на 35 млн человек больше, и это с учётом того, что Викиданные достаточно неполные. 
Попробуйте найти ошибку в запросах, представленных выше. 

TODO: 
add to margin/field (or main body) script: https://w.wiki/4$D9
instead of https://w.wiki/4$9$

Ошибка может быть связана с тем, что один населённый пункт может иметь 
несколько классов в поле "instance of", то есть его число жителей будет учитываться 
для нескольких разных строк в таблице N. Таким образом, суммарная численность будет неверной. 
