...
и принадлежащих \wdqName{России}{159} (листинг запроса~\ref{lst:human-settlement4}). 
...
Основные классы поселений, полученные с помощью запроса~\ref{lst:human-settlement4}, 
представлены в таблице~\ref{tab:human-settlement1}. 

Наличие строки шесть в~запросе~\ref{lst:human-settlement4} 
(\lstinline|wdt:P1082 []|) 
...
5 & \wdqName{хутор}{2023000}  & \num{1782}    & \num{0,51} млн\\ 
6 &\specialcell{Городское поселение\\в России (Q2661988)}& \num{1502} &  млн \\
7 & \wdqName{город}{7930989}  & \num{1170}    & \num{104} млн\\ 
8 & \wdqName{рабочий посёлок}{20019082}  & \num{583}    & \num{104} млн\\ 
9 & \wdqName{станица}{748331} & \num{255}  & \num{6,6} млн  \\
?? & \wdqName{аул}{771444} & \num{159}  & \num{6,6} млн  \\

?? &\specialcell{город с населением более\\\num{100000} человек (Q1549591)}& \num{108} & \num{58159327} \\
...
и мы его пропускаем с помощью строки~7 запроса~\ref{lst:human-settlement4}.
