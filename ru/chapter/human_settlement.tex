...
Получается, что несмотря на рост числа населённых пунктов в Викиданных 
доля пунктов с заполненным свойством <<численность населения>> постепенно увеличивается.
...
На рис.~\ref{fig:human-settlement-3} из графика видно, 
...
Для ускорения выполнения запроса~\ref{lst:human-settlement7} выполним следующие два шага.
...
Выведем список классов поселений и их количество для объектов имеющих свойство \wdProperty{1082}{численность населения} и принадлежащие государству \wdqName{России}{159} (листинг~\ref{lst:human-settlement4}). 
