...
ORDER BY ?year_lapse
\end{lstlisting}%
\footnotetext{Построена диаграмма~\protect\ref{fig:scholars-village-color} на 2022 год. Ссылка на SPARQL-запрос: \href{https://w.wiki/55VK}{https://w.wiki/55VK}}
\end{fullwidth}
...
в списке \lstinline|?jobs| перечислены 10 профессии этих учёных. 
Эти профессии мы видим в виде 10 цветных полосок на рис.~\ref{fig:scholars-village-color}, 
сами профессии перечислены на легенде внизу диаграммы. 

Мы изменим запрос~\ref{lst:scholar-village-profession} так, 
чтобы были представлены не 10 направлений (профессий), а учёные всех направление. 
Получился такой запрос~\ref{lst:???} и такая диаграмма TODO ref. 



TODO: не задавать явно список профессий, а получить список всех профессий учёных автоматически. 
Возможно, с помощью дополнительного предварительного запроса SELECT.

\begin{figure*}
    \setlength{\fboxsep}{0pt}%
    \setlength{\fboxrule}{1pt}%
    \fcolorbox{gray}{gray}{\includegraphics[width=1\linewidth]{./chapter/human_settlement/Russian_scholars_born_in_villages_filtered_by_profession.png}}
...
TODO про наведённую мышку на рисунке. 

+ TODO скрипт и диаграмма без фильтрации по профессиям: https://w.wiki/55WY

\begin{fullwidth}
    \index{График!BarChart!Диаграмма рождений отечественных учёных, родившихся в сёлах}
\begin{lstlisting}[ language=SPARQL, 
                    caption={\href{https://w.wiki/55VK}{Построение диаграммы отечественных учёных, родившихся в сёлах с разбивкой по десятилетиям}\protect\footnotemark},
...
ORDER BY ?year_lapse
\end{lstlisting}%
\footnotetext{Ссылка на SPARQL-запрос: \href{https://w.wiki/55WY}{https://w.wiki/55WY}}
\end{fullwidth}


 Диаграмма количества российских и советских учёных, родившихся в сельских поселениях в 1850-1980 годы 

\begin{figure*}
    \setlength{\fboxsep}{0pt}%
    \setlength{\fboxrule}{1pt}%
    \fcolorbox{gray}{gray}{\includegraphics[width=1\linewidth]{./chapter/human_settlement/Russian_scholars_born_in_villages_1850-1980.png}}
	\label{fig:scholars-village-blue}
    \caption[Диаграмма количества отечественных учёных, родившихся в сёлах.]{ Диаграмма количества российских и советских учёных, родившихся в сельских поселениях в 1850-1980 годы. Максимальное число учёных (685 человек) родилось в 1930-е годы. Диаграмма построена по запросу~\protect\ref{lst:scholar-village} в 2022 году.}%
\end{figure*} 
...
\begin{figure*}
	...
	\caption[Диаграмма количества учёных по родам деятельности, родившихся в городских поселениях.]{Диаграмма количества учёных по родам деятельности, родившихся в городских поселениях. Ссылка на SPARQL-запрос: \href{https://w.wiki/xxxx}{https://w.wiki/xxxx}}%
\end{figure*} 

Сравнив диаграммы, видно что учёных в городских поселениях больше примерно в 3 раза, чем в сельских поселениях. Выше мы считали количество населения с этих группах, разница в населении достигает почти в 4 раза. Следовательно можно сказать, что не важно где ты родился. 
