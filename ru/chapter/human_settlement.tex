...
то у персоны в поле \wdProperty{27}{гражданство} записаны две страны.  
...
\end{lstlisting}%
\footnotetext{Получено 4170 человек. Ссылка на SPARQL-запрос: \url{https://w.wiki/539x}}
