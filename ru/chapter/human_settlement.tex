...
\begin{lstlisting}[ language=SPARQL, 
                    caption={\href{https://w.wiki/4ya2}{Список классов поселений и их количество для объектов, имеющих свойство <<численность населения>> в России}\protect\footnotemark},
...
SELECT ?class ?classLabel (COUNT(?class) AS ?count) WHERE {
  SELECT ?class ?classLabel WHERE {
    [] wdt:P31 wd:Q486972; # instance of settlement
...
ORDER BY DESC (?count)
\end{lstlisting}%
\footnotetext{Получили 36 разных классов поселений. Ссылка на SPARQL-запрос: \href{https://w.wiki/4ya2}{https://w.wiki/4ya2}}
...
%
Задание. 
Используя команду FILTER~NOT~EXISTS 
...
Обратите внимание на безымянные переменные (\lstinline|[]|) в строках 4 и 6.
