...
\label{ch:anime}
%
\marginnote[0.0cm]{Сэйю~--- это японские актёры озвучивания. 
...
Сэйю могут быть как мужчины, так~и~женщины, как~взрослые, так и дети.}
...
\begin{marginfigure}[0.0cm]
{
	...
	\fcolorbox{gray}{gray}{\includegraphics[width=0.5\linewidth]{chapter/anime/seyu.jpg}}
}
\caption
[Сэйю Кэндзи Акабанэ.]%
{%
...
\begin{marginfigure}[1\baselineskip]
{
	\setlength{\fboxsep}{0pt}%
	\setlength{\fboxrule}{1pt}%
	\fcolorbox{gray}{gray}{\includegraphics[width=0.5\linewidth]{chapter/anime/anime-subclasses-sunburst-diagram-2021.png}}
}
\caption%
[Жанры аниме на круговой диаграмме, 2021 год.\index{Сервисы для визуализации данных!Rawgraphs}]%
{%
...
Визуализировать распределение аниме по жанрам можно с помощью, 
например, диаграммы <<солнечные лучи>> 
(рис.~\ref{fig:anime_piechart})\index{Сервисы для визуализации данных!Rawgraphs}. 
%
...
ProWD\autocite{anime_prowd} у~фильма \wdqName{Fullmetal Alchemist: The Sacred Star of Milos}{1004318}\footnote{%
%
...
\index{График!LineChart!Число сэйю, озвучивших аниме}
\begin{figure*}[h]
%    \setlength{\fboxsep}{0pt}%
%    \setlength{\fboxrule}{1pt}%
%    \fcolorbox{gray}{gray}{
...
\index{SPARQL!BIND!Граф сэйю и аниме}
\index{SPARQL!IF!Граф сэйю и аниме}
...
\newpage
\begin{figure*}[h!]
    \index{График!Graph!Граф сэйю и аниме}
%\begin{flushright}
...
{%
\index{График!Sunburst diagram!Количество ролей, озвученных актёрами}%
%\setlength{\fboxsep}{0pt}%
%\setlength{\fboxrule}{1pt}%
%\fcolorbox{gray}{gray}{
...
Круговая диаграмма\index{Сервисы для визуализации данных!Rawgraphs} 
...
подобных языку программирования Python\index{Языки программирования!Python}\footnote[][-1cm]{%
...
%
}\index{Языки программирования!Библиотеки!Pandas} 
и \href{https://ru.wikipedia.org/wiki/Matplotlib}{Matplotlib}\footnote{%[][-0.1cm]{%
%   
    \index{Языки программирования!Библиотеки!Matplotlib}
...
\index{График!Histogram!Аниме, озвученные сэйю разных возрастов}
\begin{figure*}[h!]
%    \setlength{\fboxsep}{0pt}%
%    \setlength{\fboxrule}{1pt}%
%    \fcolorbox{gray}{gray}{
