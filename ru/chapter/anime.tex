...
\begin{figure*}[h]
	...
	\caption[График числа ролей, озвученных различными сэйю, построенный с помощью сервиса Rawgraphs, 2021.]{График числа ролей, озвученных различными сэйю, построенный с помощью сервиса Rawgraphs, 2021. График построен на основе данных, полученных с помощью запроса~\protect\ref{lst:seiyu_titles_graph}.}%
