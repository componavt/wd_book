...
Чтобы работать со списком аниме, о которых есть информация на Викиданных, нам понадобятся собственно объект \wdqName{<<аниме>>}{1107}, а также свойство \wdProperty{31}{<<экземпляр>>}.
