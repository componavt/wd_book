...
Визуализировать распределение аниме по жанрам можно с помощью, например, диаграммы <<солнечные лучи>> (рис.~\protect\ref{fig:anime_piechart})\index{Сервисы для анализа данных!Сервисы для визуализации данных!Rawgraphs}.
...
\caption
[Жанры аниме на круговой диаграмме, 2021.\index{Сервисы для анализа данных!Сервисы для визуализации данных!Rawgraphs}]
{
...
Круговая диаграмма\index{Сервисы для анализа данных!Сервисы для визуализации данных!Rawgraphs} на рис.~\protect\ref{fig:roles_piechart}~--- это один из вариантов визуализации данных, полученных с помощью скрипта~\protect\ref{lst:voice_actors_list}. С помощью подобных диаграмм можно, например, оценить, какой актёр внёс наибольший вклад в развитие индустрии озвучивания.
