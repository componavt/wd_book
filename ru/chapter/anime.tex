...
{
Круговая диаграмма (sunburst diagram) жанров аниме, визуализированная с помощью сервиса Rawgraphs (\href{https://app.rawgraphs.io}{https://app.rawgraphs.io}).\newline
}
...
{
Круговая диаграмма (sunburst diagram) числа ролей, озвученных различными актёрами, визуализированная с помощью сервиса Rawgraphs (\href{https://app.rawgraphs.io}{https://app.rawgraphs.io}).\newline
}
...
\begin{figure*}[h]
	...
	\caption[Гистограмма с числом аниме, озвученное сэйю разных возрастов, 2021.]{Гистограмма с числом аниме, озвученных различными сэйю, 2021. Гистограмма построена на основе данных, полученных с помощью запроса ~\protect\ref{lst:link_anime_seiyu}.}%
