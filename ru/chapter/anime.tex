...
(рис.~\ref{fig:anime_piechart})\index{Сервисы для анализа данных!Сервисы для визуализации данных!Rawgraphs}. 
%
...
Круговая диаграмма\index{Сервисы для анализа данных!Сервисы для визуализации данных!Rawgraphs} 
...
подобных языку программирования Python\index{Языки программирования!Примеры языков программирования!Python}\footnote[][-1cm]{%
...
%
}\index{Языки программирования!Библиотеки для языков программирования!Pandas} 
и \href{https://ru.wikipedia.org/wiki/Matplotlib}{Matplotlib}\footnote{%[][-0.1cm]{%
%   
    \index{Языки программирования!Библиотеки для языков программирования!Matplotlib}
