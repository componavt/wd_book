...
\fcolorbox{gray}{gray}{\includegraphics{./chapter/prowd/ProWD-green-balance_Country.png}}
}
...
\setlength{\fboxsep}{0pt}%
\setlength{\fboxrule}{1pt}%
\fcolorbox{gray}{gray}{\includegraphics{./chapter/prowd/ProWD-red-imbalance_programming_language_2020-10-09.png}}
}
...
\todo[inline]{Что такое <<сбалансированное дерево>> в дискретной математике? Рисунок?\newline 
...
\begin{itemize}
    ...
    \item можно сравнить подклассы объекта по количеству свойств. В статье Elisabeth Giesemann\cite{Giesemann2020}\marginnote[-0cm]{
    Todo пару слов про статью Элизабет.
}
