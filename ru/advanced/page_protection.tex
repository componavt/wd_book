...
\label{protection}
%
\begin{marginfigure}[-24\baselineskip]
\centering\includegraphics[width=3cm]{"chapter/oblast_of_Russia/Semi_protect.png"}
\caption [Иконка. Частичная защита или полузащита.]{Частичная защита или полузащита.}%
\label{fig:legend_population}%
\end{marginfigure}

\begin{marginfigure}[-7\baselineskip]
\centering\includegraphics[width=3cm]{"chapter/oblast_of_Russia/Full_protect.png"}
\includegraphics[width=3cm]{"chapter/oblast_of_Russia/Permanent_protect.png"}
...
\centering\includegraphics[width=3cm]{"chapter/oblast_of_Russia/Move_protect.png"}
\caption [Иконка. Защита от переименования.]{Защита от переименования.}%
\label{fig:legend_population}%
\end{marginfigure}

\begin{marginfigure}[0\baselineskip]
\centering\includegraphics[width=3cm]{"chapter/oblast_of_Russia/Create_protect.png"}
...
%
\begin{marginfigure}
\centering\includegraphics[width=3cm]{"chapter/oblast_of_Russia/Office_action.png"}
