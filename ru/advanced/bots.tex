...
%
QuickStatements~--- сервис пакетной обработки Викиданных.\\\url{https://quickstatements.toolforge.org/}%
%
...
%  \setlength{\itemindent}{2em}
  ...
  \item установить облачную инфраструктуру наподобие Toolforge\sidenote[][-24pt]{Toolforge~--- платформа энтузиастов-программистов, разрабатывающих сервисы и программы для обработки данных проектов Викимедиа. \url{https://wikitech.wikimedia.org/wiki/Portal:Toolforge}};
...
%
        О~статьях-сиротах см.~руководство на~странице \href{https://ru.wikipedia.org/?curid=350049}{Википедия:Статьи-сироты}.  
...
Этот запрос~\ref{lst:occupation-list} позволяет найти ошибки 
